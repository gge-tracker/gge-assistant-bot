...
class GGEAssistantBot(commands.Bot):
    ...
    async def on_ready(self):
        ...
        webhook_systeme = "[WEBHOOK_SYSTEME_1_CENSURE]"
    ...
    async def on_guild_join(self, guild: discord.Guild):
        ...
        webhook_servers = "[WEBHOOK_SERVERS_1_CENSURE]"
    ...
    async def on_guild_remove(self, guild: discord.Guild):
        ...
        webhook_servers = "[WEBHOOK_SERVERS_2_CENSURE]"
        if webhook_servers.startswith("http"):
            payload = {
                "username": "GGE Serveurs 📉",
                "embeds": [
    ...
    async def vote_handler(self, request):
        ...
        webhook_votes = "[WEBHOOK_VOTES_CENSURE]"
    ...
    async def update_servers_task(self):
        ...
        webhook_url = "[WEBHOOK_URL_CENSURE]"
    ...
    # ==========================================
    WEBHOOK_SYSTEME = "[WEBHOOK_SYSTEME_2_CENSURE]"
